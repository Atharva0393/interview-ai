            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-stone-50 border border-stone-200 rounded-xl px-3 py-2 text-xs text-slate-900 focus:outline-none focus:border-violet-600 font-medium"
                />
              </div>
              <div className="space-y-1">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  >
                    <div className="text-xs font-bold text-slate-900">{item.level}</div>
                    <div className="text-[11px] text-slate-500 font-normal leading-relaxed">{item.desc}</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full bg-stone-50 border border-stone-200 rounded-xl px-3 py-2 text-xs text-slate-900 focus:outline-none focus:border-violet-600 font-medium cursor-pointer"
                >
