...
import { Sparkles, ArrowRight, Video, BarChart2, Cpu, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#f9f8f6] text-slate-900 flex flex-col justify-between selection:bg-violet-100 selection:text-violet-900">
      ...
      <header className="px-6 lg:px-16 py-5 flex items-center justify-between border-b border-[#e5e3de] bg-[#f9f8f6]/80 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard"
            className="px-4 py-2 rounded-xl text-xs font-bold bg-violet-600 hover:bg-violet-700 text-white transition-all shadow-xs cursor-pointer"
          >
            Launch Workspace
          </Link>
        </div>
      ...
      {/* Hero Body */}
      <main className="max-w-5xl mx-auto px-6 py-20 text-center space-y-8 flex-1 flex flex-col justify-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight">
          ...
          <span className="text-gradient-violet">Real-Time AI Coaching</span>
        </h1>

        <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto font-normal leading-relaxed">
          Simulate high-stakes engineering interviews with vocal evaluation, speech pacing analysis, STAR response structuring, and personalized technical feedback.
        </p>

        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/dashboard"
            className="w-full sm:w-auto px-8 py-3.5 rounded-xl font-bold text-xs bg-violet-600 hover:bg-violet-700 text-white shadow-sm hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
          ...
          <Link
            ...
            className="w-full sm:w-auto px-8 py-3.5 rounded-xl font-bold text-xs bg-white hover:bg-stone-50 text-slate-700 border border-[#e5e3de] transition-colors flex items-center justify-center gap-2 shadow-2xs cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-16 text-left">
          <div className="p-6 rounded-2xl bg-white border border-[#e5e3de] shadow-2xs space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">AI Resume Parsing</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Extract key technical skills and map your candidate profile against target job role requirements.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-[#e5e3de] shadow-2xs space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">Simulated Mock Room</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white border border-[#e5e3de] shadow-2xs space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">Deep Analytics</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
