...
export const MOCK_RECENT_INTERVIEWS: RecentInterview[] = [
  ...
  {
    id: "int-102",
    title: "Advanced Frontend Technical Mock",
    role: "Frontend Developer",
    score: 88,
    date: "2026-09-02",
    timeAgo: "5 days ago",
    ...
    feedbackSummary: "Peak performance session with strong Lighthouse and Core Web Vitals benchmarks.",
  },
  {
    id: "int-103",
    title: "Frontend & STAR Framework Mock",
    role: "Frontend Developer",
    score: 82,
    date: "2026-08-28",
    timeAgo: "1 week ago",
    ...
    questionsCount: 8,
    status: "Completed",
    tags: ["Behavioral", "STAR Method", "Problem Solving"],
