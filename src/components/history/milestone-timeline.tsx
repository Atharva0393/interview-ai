...
export function MilestoneTimeline() {
  ...
  return (
    <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#e5e3de] shadow-2xs space-y-6">
      <div>
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-stone-100 border border-stone-200 text-xs font-semibold text-slate-800 mb-2">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 rounded text-[10px] font-extrabold border bg-slate-900 text-white border-slate-900">
                  {m.score}
                </span>
              </div>
