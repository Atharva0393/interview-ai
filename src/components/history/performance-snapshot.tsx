...
export function PerformanceSnapshot() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
      {/* Latest Score Card */}
      <div className="p-6 rounded-2xl bg-white border border-stone-200/80 shadow-2xs space-y-3 relative overflow-hidden group">
        <div className="flex items-center justify-between">
          <span className="text-xs font-bold text-slate-900 uppercase tracking-wider">
            Current Overall Score
          </span>
          <span className="px-2.5 py-0.5 rounded-full bg-slate-900 text-white border border-slate-900 text-[10px] font-extrabold">
            Latest Session
          </span>
        </div>
        ...
        <div className="flex items-baseline justify-between">
          ...
          <div className="flex items-center gap-1 text-xs font-bold text-emerald-800 bg-emerald-50 border border-emerald-200 px-2.5 py-1 rounded-full">
