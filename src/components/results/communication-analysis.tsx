...
export function CommunicationAnalysis() {
  return (
    <div className="p-6 rounded-2xl bg-white border border-[#e5e3de] shadow-2xs space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
        ...
        <div className="p-3 rounded-xl bg-stone-50 border border-stone-200 space-y-0.5">
          ...
          <div className="text-xs font-bold text-violet-700">Confident</div>
        </div>
