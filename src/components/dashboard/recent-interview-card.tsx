...
export function RecentInterviewCard({ interview }: RecentInterviewCardProps) {
  const scoreColor =
    interview.score >= 85
      ...
      : interview.score >= 75
      ? "text-slate-900 border-stone-300 bg-stone-100"
      : "text-stone-700 border-stone-200 bg-stone-50";

  return (
    <div className="p-5 rounded-2xl bg-white border border-stone-200/80 hover:border-slate-400 transition-all duration-200 group shadow-2xs flex flex-col justify-between">
      <div>
      ...
      <div className="pt-3 border-t border-stone-100 flex items-center justify-between">
        ...
        <Link
          href="/results"
          className="inline-flex items-center gap-1 text-xs font-bold text-slate-900 hover:text-black transition-colors group/link"
        >
