  ...
  return (
    <div className="p-6 rounded-2xl bg-white border border-stone-200/80 shadow-2xs space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] font-mono text-slate-900 bg-stone-100 px-2 py-0.5 rounded border border-stone-300 font-bold">
          Visual System Map
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center text-center">
        ...
        <div className="grid grid-cols-2 gap-2 text-left">
          ...
          <div className="p-2.5 rounded-xl bg-stone-50 border border-stone-200 flex items-center gap-2">
            <Mic className="w-3.5 h-3.5 text-slate-900 shrink-0" />
        ...
        <div className="p-4 rounded-2xl bg-stone-900 border border-stone-800 text-white space-y-1 my-2 md:my-0 shadow-2xs">
          <div className="w-8 h-8 rounded-xl bg-white text-black flex items-center justify-center mx-auto">
            <Cpu className="w-4 h-4" />
          </div>
          <div className="text-xs font-extrabold text-white">AI Feedback Engine</div>
          <p className="text-[10px] text-stone-300 font-medium">Multimodal Neural Fusion</p>
        </div>
